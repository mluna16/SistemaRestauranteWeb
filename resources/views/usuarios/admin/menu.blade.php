            ...
            <div class="col s12 m6 l4">
                <div class="card" id="CardMenu{{$menu['id_product']}}">
                    ...
                    <div class="card-reveal">
                        ...
                        <div class="row">
                            <a href="#" class="btn tooltipped col s4 offset-s4 l2 offset-l1 EditProduct" data-position="top" data-delay="50" data-tooltip="Editar"><i class="tiny mdi-editor-mode-edit "></i></a>
                            @if($menu['status'] == true)

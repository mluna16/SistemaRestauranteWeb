...
@section('TextoTour') Elmodulo de Menu, permite listar el menu de los prductos ofrecidos por el restaurante. @endsection

<div id="MenuPrincipal">
@section('infoPanel')
    <div class="row" id="MenuPrincipal" data-step="2" data-intro="lista de todo los productos con informacion detallada de cada uno." data-position='left'>
        @if($products != null)
            @foreach($products as $i => $menu)
                <div class="col s12 m6 l4">
                    @if($i == 0)
                    <div class="card" id="CardMenu{{$menu['id_product']}}" data-step="3" data-intro="Informacion detalla del producto {{$menu['name']}}" data-position='left'>
                        ...
                        <div class="card-content">
                            <div class="row">
                                <div class="col s12">
                                    <span class="card-title activator grey-text text-darken-4">{{$menu['name']}} <i data-step="4" data-intro="Boton que muestra informacion mas detallada." data-position='left' class="mdi-navigation-more-vert right"></i></span>
                                </div>
                            </div>
                        </div>
